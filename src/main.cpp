...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 5); // starting difficulty is 1 / 2^12
...
const string strMessageMagic = "JewCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // JewCoin: 1 days
static const int64 nTargetSpacing = 30; // JewCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal JewCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "JewCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc3b31172fe92112cc7456a91a37e8d5bfccb7da4c97a28db426eb84737654a85");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Colorado set to enact broad set of recreational marijuana laws";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1369814417; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1369814417;
            block.nNonce   = 975074;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2afe38ed33136d15d84472a1b851cbdd0f1fedc9da4b78e5caf1886bd1852cdb"));
